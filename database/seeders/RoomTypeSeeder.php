...
class RoomTypeSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('room_type')->insert([
            ...
            ['name' => "Triple Bedroom", "description" => "Phòng 1 giường đôi và 1 giường đơn cho 3 người", "quantity" => 10, "hourly_rate" => 10000, "full_day_rate" => 200000, "overnight_rate" => 100000, "status" => "Ngừng kinh doanh"],
